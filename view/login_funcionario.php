...
<body class="auth-bg">
        ...
        <section class="auth-card">
            ...
            <section class="auth-messages">
                <?php if(isset($_GET['erro'])): ?>
                    <article class="alert alert-error">
                        <?php 
                            ...
                            elseif($_GET['erro'] == 'email_existente') echo "Este e-mail corporativo já está cadastrado.";
                            elseif($_GET['erro'] == 'email_nao_encontrado') echo "E-mail não localizado.";
                            elseif($_GET['erro'] == 'codigo_invalido') echo "O código informado é inválido.";
                        ?>
                    </article>
                <?php endif; ?>
                ...
                <?php if(isset($_GET['sucesso'])): ?>
                    <article class="alert alert-success">
                        <?php 
                            if($_GET['sucesso'] == 'cadastro_realizado') echo "Cadastro realizado com sucesso! Faça seu login.";
            ...
            <article id="section-forgot-reset" class="auth-section <?php echo $showReset ? '' : 'hidden'; ?>">
                ...
                <form action="../controller/processa_auth.php" method="POST" class="auth-form">
                    ...
                    <a href="login_funcionario.php" class="btn-back-login link-btn w-100 d-block text-center mt-1">Voltar para o login</a>
                </form>
            </article>
            ...
            <article id="section-register" class="auth-section <?php echo $showRegister ? '' : 'hidden'; ?>">
                ...
                <form id="form-register-func" action="../controller/processa_auth.php" method="POST" class="auth-form" data-codigo="<?php echo htmlspecialchars($_SESSION['codigo_funcionario']); ?>">
    ...
    <?php if (isset($_SESSION['codigo_funcionario'])): ?>
    <script>
        console.log("[SISTEMA] CÓDIGO DE AUTORIZAÇÃO PARA NOVO FUNCIONÁRIO: <?php echo $_SESSION['codigo_funcionario']; ?>");
    </script>
    <?php endif; ?>
</body>
</html>